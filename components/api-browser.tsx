...
import {Code, FunctionSquare, Search, Sparkles} from "lucide-react"
        ...
        <TooltipProvider>
            <Card className="h-full overflow-hidden border-2 border-amber-500/50 bg-game-card shadow-glow">
                ...
                <CardContent className="p-0 overflow-hidden">
                    ...
                    {searchTerm ? (
                        <div
                            className="p-4 space-y-4 max-h-[calc(100vh-320px)] overflow-y-auto scrollbar-thin scrollbar-thumb-amber-600 scrollbar-track-amber-900/30">
                                ...
                                <div key={category.name} className="space-y-2">
                                    <h3 className="font-medium text-sm text-amber-400 flex items-center">
                                        ...
                                        <Badge variant="outline"
                                               className="ml-2 text-xs border-amber-500/50 text-amber-300">
                        ...
                        >
                            <TabsList
                                className="grid grid-cols-7 h-12 rounded-none bg-game-header border-b border-amber-500/30">
