        ...
        <TooltipProvider>
            <Card className="border-2 border-amber-500/50 bg-game-card shadow-glow">
                    ...
                    <div className="flex items-center justify-between">
                        ...
                        <DropdownMenu>
                            ...
                            <DropdownMenuContent className="bg-game-card border-amber-500/50">
                                ...
                                <DropdownMenuLabel className="text-xs text-amber-500/70 pt-2">Inside Main
                                    Loop</DropdownMenuLabel>
                                <DropdownMenuItem
                                ...
                                <DropdownMenuLabel className="text-xs text-amber-500/70 pt-2">Outside Main
                                    Loop</DropdownMenuLabel>
                                <DropdownMenuItem
                                    className="text-amber-200 focus:text-amber-100 focus:bg-amber-800/50"
                ...
                <CardContent className="p-4" ref={setDroppableRef}>
                    {statements.length === 0 ? (
                        <div
                            className="text-center py-12 px-6 border-2 border-dashed border-amber-500/30 rounded-lg bg-amber-900/20 animate-pulse-slow">
      ...
      `}
        ...
        `}
            >
                ...
                {statement.function?.name ?? "unknown"}({statement.parameters?.map((p) => p.value || "nil").join(", ") ?? ""})
              </span>
                        ) : (
                        ...
                        {statement.type === "function" ? (
                                ...
                                {(statement.parameters || []).map((param, paramIndex) => (
                                    <div key={param.name} className="grid grid-cols-3 gap-2 items-center">
                                        <div className="flex items-center">
                                            <Label htmlFor={`${statement.id}-${param.name}`}
                                            ...
                                            <Tooltip>
                                                ...
                                                <TooltipContent>
                                                    ...
                                                    <Badge variant="outline"
                                                           className={`mt-1 ${getParamTypeColor(param.type)}`}>
                                                        {param.type}
                                                    </Badge>
                                                </TooltipContent>
                                            </Tooltip>
                                        ...
                                        {param.type.includes("boolean") ? (
                                            ...
                                            >
                                                <SelectTrigger
                                                    className="col-span-2 h-8 bg-amber-900/30 border-amber-500/50 text-amber-100">
                            ...
                            <>
                                ...
                                {statement.controlType === "for" && (
                                    <>
                                        <div className="grid grid-cols-3 gap-2 items-center">
                                            <Label htmlFor={`${statement.id}-variable`}
                                                   className="text-sm text-amber-200">
                                                Variable:
                                            </Label>
                                            <Input
                                ...
                                {statement.controlType === "function" && (
                                    <>
                                        <div className="grid grid-cols-3 gap-2 items-center">
                                            <Label htmlFor={`${statement.id}-function-name`}
                                                   className="text-sm text-amber-200">
                                                Function Name:
                                            </Label>
                                            <Input
                                        ...
                                        <div className="grid grid-cols-3 gap-2 items-center">
                                            <Label htmlFor={`${statement.id}-function-params`}
                                                   className="text-sm text-amber-200">
                                                Parameters:
                                            </Label>
                                            <Input
                                        ...
                                        <div className="space-y-2">
                                            <Label htmlFor={`${statement.id}-function-body`}
                                                   className="text-sm text-amber-200">
                                                Function Body:
                                            </Label>
                                            <Textarea
                                ...
                                {statement.controlType !== "function" && (
                                    <div className="flex items-center space-x-2 mt-4 pt-2 border-t border-amber-500/20">
                                        <Switch
                                            ...
                                            className="data-[state=checked]:bg-amber-600"
                                        />
                                        <Label htmlFor={`${statement.id}-in-main-loop`}
                                               className="text-sm text-amber-200">
                                            Place inside main loop
                                        </Label>
                                    </div>
